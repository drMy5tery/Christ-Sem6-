...
public class sa_face extends AppCompatActivity {
  ...
  int i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sa_face);
        ...
        mp = MediaPlayer.create(sa_face.this,R.raw.success);
...
//    }
    ...
    public void next1(View v){
        ...
        storageReference = storage.getReference().child("Voters/"+uname+"/id-card");
        ...
        storageReference2 = storage2.getReference().child("Voters/"+uname+"/face");
      ...
      client.newCall(request).enqueue(new Callback() {
          ...
          public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
              if (response.isSuccessful()) {
                  ...
                  sa_face.this.runOnUiThread(new Runnable() {
                      @Override
                      public void run() {
                          try {
