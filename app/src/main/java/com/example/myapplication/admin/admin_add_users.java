...
public class admin_add_users extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                reference_root=rootNode.getReference().child("Voters");
                ...
                for(String  single_Email: mailS){
                    if(email_validate(single_Email)){
                        ...
                        if(check_user(single_Email)!=true) {
                            ...
                            reference_root = reference_root.getDatabase().getReference(org_name).child("Voters").child(uniqueID);
                            user_add_details edetail = new user_add_details(single_Email,uniqueID,0);
    ...
    private boolean del_user(String s_Email){
        ...
        Query applesQuery = ref.child(org_name).child("Voters").orderByChild("eMail").equalTo(s_Email);
