...
public class admin_upload_photo extends AppCompatActivity {
    ...
    public void textrecognition(){
        ...
        detector.detectInImage(image).addOnSuccessListener(new OnSuccessListener<FirebaseVisionText>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(getApplicationContext(), "Fail to detect the text from image..", Toast.LENGTH_SHORT).show();
            }
        });
...
//
//        Intent i= new Intent(getApplicationContext(), sa_face.class);
//        startActivity(i);
//    }
    ...
    public void next(View v){
       ...
       // String uname="9e8448fe-e96e-4ce8";
        Intent intent = new Intent(getApplicationContext(), admin_face_upload.class);
        ...
        storageReference2 = storage2.getReference().child("Christ/Admin/"+uname+"/id-card");
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                    if (response.isSuccessful()) {
                        ...
                        admin_upload_photo.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                try {
