...
public class superadmin_add_admin extends AppCompatActivity {
        ImageButton add,delete;
        FirebaseDatabase rootNode;
        DatabaseReference reference_root,reference_uid;
        EditText etEmail;
        String mailID,org_name;
        boolean ret_value;
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_superadmin_add_admin);
            org_name="Christ";
            ...
            add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    reference_root=rootNode.getReference().child("Admin");
                    ...
                    for(String  single_Email: mailS){
                        if(email_validate(single_Email)){
                            if(check_user(single_Email)!=true) {
                               ...
                               // Toast.makeText(getApplicationContext(),"Some Of the Emails Are Invalid",Toast.LENGTH_LONG).show();
                                reference_root = reference_root.getDatabase().getReference(org_name).child("Admin").child(uniqueID);
                                admin_add_details edetail = new admin_add_details(single_Email,uniqueID,0);
                                reference_uid = reference_root;
                                reference_uid.setValue(edetail);
                                java_send_func_mail javaMailAPI = new java_send_func_mail(getApplicationContext(),single_Email,"Votezy","You have been Successfully Registered to Votezy !..\n Please Validate your id : "+uniqueID+" in the app to further Proceed");
                                javaMailAPI.execute();
                            }
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String mailS []=mailID.split(",");
                    for(String  single_Email: mailS){
                        del_user(single_Email);
                    }

                }
            });
        }
    private boolean del_user(String s_Email){
        ...
        Query applesQuery = ref.child(org_name).child("Admin").orderByChild("eMail").equalTo(s_Email);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot appleSnapshot: dataSnapshot.getChildren()) {
                    if (appleSnapshot.exists()) {
                        ...
                        Toast.makeText(getApplicationContext(), " Email's Removed",Toast.LENGTH_LONG).show();
                        ret_value=true;
                    }
                    else {
    ...
    public static boolean email_validate(String emailStr) {
